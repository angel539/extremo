...
public class SemanticmanagerAdapterFactory extends AdapterFactoryImpl {
	...
	protected SemanticmanagerSwitch<Adapter> modelSwitch =
		new SemanticmanagerSwitch<Adapter>() {
			...
			@Override
			public Adapter caseFormatAssistant(FormatAssistant object) {
				return createFormatAssistantAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link semanticmanager.FormatAssistant <em>Format Assistant</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createFormatAssistantAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link semanticmanager.ModelPersistence <em>Model Persistence</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
