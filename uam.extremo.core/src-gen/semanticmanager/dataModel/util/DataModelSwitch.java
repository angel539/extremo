...
public class DataModelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case DataModelPackage.RESOURCE: {
			...
			case DataModelPackage.SEMANTIC_NODE: {
			...
			case DataModelPackage.NAMED_ELEMENT: {
				NamedElement namedElement = (NamedElement)theEObject;
				T result = caseNamedElement(namedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DataModelPackage.PROPERTY: {
			...
			case DataModelPackage.OBJECT_PROPERTY: {
			...
			case DataModelPackage.DATA_PROPERTY: {
