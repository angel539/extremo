 ...
 *   <li>{@link semanticmanager.impl.SearchConfigurationImpl#getDescription <em>Description</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class SearchConfigurationImpl extends DefaultPersistentEObject implements SearchConfiguration {
	...
	public String getDescription() {
		return (String)eGet(SemanticmanagerPackage.Literals.SEARCH_CONFIGURATION__DESCRIPTION, true);
	}
	...
	public void setDescription(String newDescription) {
		eSet(SemanticmanagerPackage.Literals.SEARCH_CONFIGURATION__DESCRIPTION, newDescription);
	}
