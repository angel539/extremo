...
public class SemanticmanagerPackageImpl extends EPackageImpl implements SemanticmanagerPackage {
	 ...
	 * @generated
	 */
	private EClass formatAssistantEClass = null;
	 ...
	 * @generated
	 */
	public EReference getRepositoryManager_ConstraintInterpreters() {
	 ...
	 * @generated
	 */
	public EReference getRepositoryManager_FormatAssistants() {
		return (EReference)repositoryManagerEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EReference getRepositoryManager_ModelPersistences() {
		return (EReference)repositoryManagerEClass.getEStructuralFeatures().get(5);
	}
	...
	public EAttribute getSearchConfiguration_Description() {
		return (EAttribute)searchConfigurationEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EOperation getSimpleSearchConfiguration__Init__EList() {
		return simpleSearchConfigurationEClass.getEOperations().get(2);
	}
	 ...
	 * @generated
	 */
	public EOperation getSimpleSearchConfiguration__GetParamValue__String_EList() {
		return simpleSearchConfigurationEClass.getEOperations().get(3);
	}
	 ...
	 * @generated
	 */
	public EOperation getSimpleSearchConfiguration__GetServiceForParamValue__String_EList() {
		return simpleSearchConfigurationEClass.getEOperations().get(4);
	}
	...
	public EAttribute getCompositeSearchConfiguration_Type() {
		return (EAttribute)compositeSearchConfigurationEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getCompositeSearchConfiguration_SearchConfigurations() {
		return (EReference)compositeSearchConfigurationEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getCompositeSearchConfiguration_InputSearchResults() {
	 ...
	 * @generated
	 */
	public EOperation getCustomSearch__Search__Repository_SearchResult() {
	 ...
	 * @generated
	 */
	public EReference getResource_Assistant() {
	 ...
	 * @generated
	 */
	public EReference getResource_GuardSemanticNodes() {
	 ...
	 * @generated
	 */
	public EReference getSemanticNode_Domain() {
	 ...
	 * @generated
	 */
	public EClass getFormatAssistant() {
		return formatAssistantEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getFormatAssistant_Id() {
		return (EAttribute)formatAssistantEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getFormatAssistant_Name() {
		return (EAttribute)formatAssistantEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getFormatAssistant_Extensions() {
		return (EAttribute)formatAssistantEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getFormatAssistant_Interpreter() {
		return (EAttribute)formatAssistantEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EReference getFormatAssistant_ConstraintInterpreter() {
		return (EReference)formatAssistantEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EOperation getFormatAssistant__LoadAndValidate__Resource_ConstraintInterpreter() {
		return formatAssistantEClass.getEOperations().get(0);
	}
	 ...
	 * @generated
	 */
	public EOperation getFormatAssistant__ToDataProperty__SemanticNode() {
		return formatAssistantEClass.getEOperations().get(1);
	}
	 ...
	 * @generated
	 */
	public EOperation getFormatAssistant__ToObjectProperty__SemanticNode() {
		return formatAssistantEClass.getEOperations().get(2);
	}
	 ...
	 * @generated
	 */
	public EOperation getFormatAssistant__ToSuper__SemanticNode() {
		return formatAssistantEClass.getEOperations().get(3);
	}
	 ...
	 * @generated
	 */
	public EOperation getFormatAssistant__ToSuper__DataProperty() {
		return formatAssistantEClass.getEOperations().get(4);
	}
	 ...
	 * @generated
	 */
	public EOperation getFormatAssistant__ToSuper__ObjectProperty() {
		return formatAssistantEClass.getEOperations().get(5);
	}
	 ...
	 * @generated
	 */
	public EOperation getFormatAssistant__ToInverseOf__ObjectProperty() {
		return formatAssistantEClass.getEOperations().get(6);
	}
	 ...
	 * @generated
	 */
	public EAttribute getModelPersistence_Id() {
	 ...
	 * @generated
	 */
	public EAttribute getModelPersistence_Name() {
	 ...
	 * @generated
	 */
	public EOperation getModelPersistence__Load__String() {
		return modelPersistenceEClass.getEOperations().get(0);
	}
	 ...
	 * @generated
	 */
	public EOperation getModelPersistence__Save() {
		return modelPersistenceEClass.getEOperations().get(1);
	}
	 ...
	 * @generated
	 */
	public EOperation getModelPersistence__AddContent__RepositoryManager() {
		return modelPersistenceEClass.getEOperations().get(2);
	}
	 ...
	 * @generated
	 */
	public EOperation getModelPersistence__GetContent() {
		return modelPersistenceEClass.getEOperations().get(3);
	}
	...
	public void createPackageContents() {
		...
		createEReference(repositoryManagerEClass, REPOSITORY_MANAGER__CONSTRAINT_INTERPRETERS);
		createEReference(repositoryManagerEClass, REPOSITORY_MANAGER__SERVICES);
		createEReference(repositoryManagerEClass, REPOSITORY_MANAGER__FORMAT_ASSISTANTS);
		createEReference(repositoryManagerEClass, REPOSITORY_MANAGER__MODEL_PERSISTENCES);
		...
		createEAttribute(searchConfigurationEClass, SEARCH_CONFIGURATION__DESCRIPTION);
		...
		createEOperation(simpleSearchConfigurationEClass, SIMPLE_SEARCH_CONFIGURATION___INIT__ELIST);
		createEOperation(simpleSearchConfigurationEClass, SIMPLE_SEARCH_CONFIGURATION___GET_PARAM_VALUE__STRING_ELIST);
		createEOperation(simpleSearchConfigurationEClass, SIMPLE_SEARCH_CONFIGURATION___GET_SERVICE_FOR_PARAM_VALUE__STRING_ELIST);
		...
		createEReference(compositeSearchConfigurationEClass, COMPOSITE_SEARCH_CONFIGURATION__SEARCH_CONFIGURATIONS);
		createEReference(compositeSearchConfigurationEClass, COMPOSITE_SEARCH_CONFIGURATION__INPUT_SEARCH_RESULTS);
		...
		createEOperation(customSearchEClass, CUSTOM_SEARCH___SEARCH__REPOSITORY_SEARCHRESULT);
		...
		createEReference(resourceEClass, RESOURCE__ASSISTANT);
		createEReference(resourceEClass, RESOURCE__GUARD_SEMANTIC_NODES);
		...
		createEReference(semanticNodeEClass, SEMANTIC_NODE__DOMAIN);
		...
		formatAssistantEClass = createEClass(FORMAT_ASSISTANT);
		createEAttribute(formatAssistantEClass, FORMAT_ASSISTANT__ID);
		createEAttribute(formatAssistantEClass, FORMAT_ASSISTANT__NAME);
		createEAttribute(formatAssistantEClass, FORMAT_ASSISTANT__EXTENSIONS);
		createEAttribute(formatAssistantEClass, FORMAT_ASSISTANT__INTERPRETER);
		createEReference(formatAssistantEClass, FORMAT_ASSISTANT__CONSTRAINT_INTERPRETER);
		createEOperation(formatAssistantEClass, FORMAT_ASSISTANT___LOAD_AND_VALIDATE__RESOURCE_CONSTRAINTINTERPRETER);
		createEOperation(formatAssistantEClass, FORMAT_ASSISTANT___TO_DATA_PROPERTY__SEMANTICNODE);
		createEOperation(formatAssistantEClass, FORMAT_ASSISTANT___TO_OBJECT_PROPERTY__SEMANTICNODE);
		createEOperation(formatAssistantEClass, FORMAT_ASSISTANT___TO_SUPER__SEMANTICNODE);
		createEOperation(formatAssistantEClass, FORMAT_ASSISTANT___TO_SUPER__DATAPROPERTY);
		createEOperation(formatAssistantEClass, FORMAT_ASSISTANT___TO_SUPER__OBJECTPROPERTY);
		createEOperation(formatAssistantEClass, FORMAT_ASSISTANT___TO_INVERSE_OF__OBJECTPROPERTY);

		modelPersistenceEClass = createEClass(MODEL_PERSISTENCE);
		createEAttribute(modelPersistenceEClass, MODEL_PERSISTENCE__ID);
		createEAttribute(modelPersistenceEClass, MODEL_PERSISTENCE__NAME);
		createEOperation(modelPersistenceEClass, MODEL_PERSISTENCE___LOAD__STRING);
		createEOperation(modelPersistenceEClass, MODEL_PERSISTENCE___SAVE);
		createEOperation(modelPersistenceEClass, MODEL_PERSISTENCE___ADD_CONTENT__REPOSITORYMANAGER);
		createEOperation(modelPersistenceEClass, MODEL_PERSISTENCE___GET_CONTENT);
	...
	public void initializePackageContents() {
		...
		initEReference(getRepositoryManager_ConstraintInterpreters(), this.getConstraintInterpreter(), null, "constraintInterpreters", null, 0, -1, RepositoryManager.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getRepositoryManager_FormatAssistants(), this.getFormatAssistant(), null, "formatAssistants", null, 0, -1, RepositoryManager.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRepositoryManager_ModelPersistences(), this.getModelPersistence(), null, "modelPersistences", null, 0, -1, RepositoryManager.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getSearchConfiguration_Description(), ecorePackage.getEString(), "description", null, 0, 1, SearchConfiguration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		op = initEOperation(getSimpleSearchConfiguration__Init__EList(), null, "init", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getSearchParamValue(), "inputs", 0, -1, IS_UNIQUE, IS_ORDERED);

		op = initEOperation(getSimpleSearchConfiguration__GetParamValue__String_EList(), this.getJavaObject(), "getParamValue", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEString(), "key", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getSearchParamValue(), "inputs", 0, -1, IS_UNIQUE, IS_ORDERED);

		op = initEOperation(getSimpleSearchConfiguration__GetServiceForParamValue__String_EList(), this.getService(), "getServiceForParamValue", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEString(), "key", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getSearchParamValue(), "inputs", 0, -1, IS_UNIQUE, IS_ORDERED);
		...
		initEReference(getCompositeSearchConfiguration_SearchConfigurations(), this.getSearchConfiguration(), null, "searchConfigurations", null, 0, -1, CompositeSearchConfiguration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCompositeSearchConfiguration_InputSearchResults(), this.getSearchResult(), null, "inputSearchResults", null, 0, -1, CompositeSearchConfiguration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		op = initEOperation(getCustomSearch__Search__Repository_SearchResult(), null, "search", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEReference(getResource_Assistant(), this.getFormatAssistant(), null, "assistant", null, 0, 1, Resource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getResource_GuardSemanticNodes(), this.getSemanticNode(), null, "guardSemanticNodes", null, 0, -1, Resource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getSemanticNode_Domain(), this.getObjectProperty(), this.getObjectProperty_Range(), "domain", null, 0, -1, SemanticNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getObjectProperty_Range(), this.getSemanticNode(), this.getSemanticNode_Domain(), "range", null, 0, 1, ObjectProperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(formatAssistantEClass, FormatAssistant.class, "FormatAssistant", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getFormatAssistant_Id(), ecorePackage.getEString(), "id", null, 0, 1, FormatAssistant.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getFormatAssistant_Name(), ecorePackage.getEString(), "name", null, 0, 1, FormatAssistant.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getFormatAssistant_Extensions(), ecorePackage.getEString(), "extensions", null, 0, -1, FormatAssistant.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getFormatAssistant_Interpreter(), ecorePackage.getEString(), "interpreter", null, 0, 1, FormatAssistant.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFormatAssistant_ConstraintInterpreter(), this.getConstraintInterpreter(), null, "constraintInterpreter", null, 0, 1, FormatAssistant.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		op = initEOperation(getFormatAssistant__LoadAndValidate__Resource_ConstraintInterpreter(), ecorePackage.getEBoolean(), "loadAndValidate", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getResource(), "resource", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getConstraintInterpreter(), "constraintInterpreter", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = initEOperation(getFormatAssistant__ToDataProperty__SemanticNode(), null, "toDataProperty", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getSemanticNode(), "node", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = initEOperation(getFormatAssistant__ToObjectProperty__SemanticNode(), null, "toObjectProperty", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getSemanticNode(), "node", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = initEOperation(getFormatAssistant__ToSuper__SemanticNode(), null, "toSuper", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getSemanticNode(), "node", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = initEOperation(getFormatAssistant__ToSuper__DataProperty(), null, "toSuper", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getDataProperty(), "dataProperty", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = initEOperation(getFormatAssistant__ToSuper__ObjectProperty(), null, "toSuper", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getObjectProperty(), "objectProperty", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = initEOperation(getFormatAssistant__ToInverseOf__ObjectProperty(), null, "toInverseOf", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getObjectProperty(), "objectProperty", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEAttribute(getModelPersistence_Id(), ecorePackage.getEString(), "id", null, 0, 1, ModelPersistence.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getModelPersistence_Name(), ecorePackage.getEString(), "name", null, 0, 1, ModelPersistence.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		op = initEOperation(getModelPersistence__Load__String(), ecorePackage.getEBoolean(), "load", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEString(), "path", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEOperation(getModelPersistence__Save(), ecorePackage.getEBoolean(), "save", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = initEOperation(getModelPersistence__AddContent__RepositoryManager(), ecorePackage.getEBoolean(), "addContent", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getRepositoryManager(), "repositoryManager", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEOperation(getModelPersistence__GetContent(), this.getRepositoryManager(), "getContent", 0, 1, IS_UNIQUE, IS_ORDERED);
