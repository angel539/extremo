/**
 */
package semanticmanager.constraints.util;
...
import semanticmanager.constraints.*;
 ...
 * <!-- end-user-doc -->
 * @see semanticmanager.constraints.ConstraintsPackage
 * @generated
 */
public class ConstraintsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ConstraintsPackage.CONSTRAINT_INTERPRETER: {
			...
			case ConstraintsPackage.CONSTRAINT_RESULT: {
