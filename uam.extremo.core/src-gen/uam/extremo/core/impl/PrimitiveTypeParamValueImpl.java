 ...
 * </p>
 * <ul>
 *   <li>{@link uam.extremo.core.impl.PrimitiveTypeParamValueImpl#getValue <em>Value</em>}</li>
 *   <li>{@link uam.extremo.core.impl.PrimitiveTypeParamValueImpl#getOption <em>Option</em>}</li>
 *   <li>{@link uam.extremo.core.impl.PrimitiveTypeParamValueImpl#getCalls <em>Calls</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PrimitiveTypeParamValueImpl extends SearchParamValueImpl implements PrimitiveTypeParamValue {
	 ...
	 * @generated
	 */
	public PrimitiveTypeParam getOption() {
		return (PrimitiveTypeParam)eGet(SemanticmanagerPackage.Literals.PRIMITIVE_TYPE_PARAM_VALUE__OPTION, true);
	}
	 ...
	 * @generated
	 */
	public void setOption(PrimitiveTypeParam newOption) {
		eSet(SemanticmanagerPackage.Literals.PRIMITIVE_TYPE_PARAM_VALUE__OPTION, newOption);
	}
