...
public class DataPropertyImpl extends PropertyImpl implements DataProperty {
	...
	public void setType(Type newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SemanticmanagerPackage.DATA_PROPERTY__TYPE, oldType, type));
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SemanticmanagerPackage.DATA_PROPERTY__VALUE, oldValue, value));
	}
