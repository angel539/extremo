/**
 */
package metardf.model.semantics.util;
...
public class SemanticsAdapterFactory extends AdapterFactoryImpl {
	...
	protected SemanticsSwitch<Adapter> modelSwitch =
		new SemanticsSwitch<Adapter>() {
			...
			@Override
			public Adapter caseSemanticDescription(SemanticDescription object) {
				return createSemanticDescriptionAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link metardf.model.semantics.Entity <em>Entity</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link metardf.model.semantics.SemanticDescription <em>Semantic Description</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createSemanticDescriptionAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link metardf.model.semantics.Property <em>Property</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link metardf.model.semantics.Descriptor <em>Descriptor</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
