...
public class SemanticModelUtils {
	...
	public boolean compareSemanticElement(ISemanticElement element1, ISemanticElement element2){
	...
	public ArrayList<ISemanticElement> getUnique(ArrayList<ISemanticElement> list) {
		HashSet<ISemanticElement> hs = new HashSet<ISemanticElement>();
		hs.addAll(list);
		list.clear();
		list.addAll(hs);
		return list;
