...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>semanticmanager</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class SemanticmanagerExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(SemanticmanagerPackage.eNS_URI, 
			 SemanticmanagerPackage.eINSTANCE);
