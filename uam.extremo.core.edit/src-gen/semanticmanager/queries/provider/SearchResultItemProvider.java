...
/**
 * This is the item provider adapter for a {@link semanticmanager.queries.SearchResult} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SearchResultItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 QueriesPackage.Literals.SEARCH_RESULT__APPLY_ON_ELEMENTS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(QueriesPackage.Literals.SEARCH_RESULT__VALUES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SearchResult.class)) {
			case QueriesPackage.SEARCH_RESULT__VALUES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(QueriesPackage.Literals.SEARCH_RESULT__VALUES,
				 QueriesFactory.eINSTANCE.createSearchResultOptionValue()));
	}
