...
/**
 * This is the item provider adapter for a {@link uam.extremo.core.Constraint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConstraintItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SemanticmanagerPackage.Literals.CONSTRAINT__TYPE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SemanticmanagerPackage.Literals.CONSTRAINT__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SemanticmanagerPackage.Literals.CONSTRAINT__BODY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addEvaluationsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Constraint_evaluations_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Constraint_evaluations_feature", "_UI_Constraint_type"),
				 SemanticmanagerPackage.Literals.CONSTRAINT__EVALUATIONS,
				 true,
				 false,
				 true,
				 null,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Constraint.class)) {
			case SemanticmanagerPackage.CONSTRAINT__TYPE:
			case SemanticmanagerPackage.CONSTRAINT__NAME:
			case SemanticmanagerPackage.CONSTRAINT__BODY:
