...
/**
 * This is the item provider adapter for a {@link uam.extremo.core.SearchResult} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SearchResultItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SemanticmanagerPackage.Literals.SEARCH_RESULT__VALUES);
		}
		...
		newChildDescriptors.add
			(createChildParameter
				(SemanticmanagerPackage.Literals.SEARCH_RESULT__VALUES,
				 SemanticmanagerFactory.eINSTANCE.createModelTypeParamValue()));

		newChildDescriptors.add
			(createChildParameter
				(SemanticmanagerPackage.Literals.SEARCH_RESULT__VALUES,
				 SemanticmanagerFactory.eINSTANCE.createPrimitiveTypeParamValue()));
	}
