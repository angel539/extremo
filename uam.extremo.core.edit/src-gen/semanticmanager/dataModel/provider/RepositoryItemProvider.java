...
/**
 * This is the item provider adapter for a {@link semanticmanager.dataModel.Repository} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RepositoryItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DataModelPackage.Literals.REPOSITORY__PROJECT,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DataModelPackage.Literals.REPOSITORY__RESOURCES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Repository.class)) {
			case DataModelPackage.REPOSITORY__PROJECT:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case DataModelPackage.REPOSITORY__RESOURCES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DataModelPackage.Literals.REPOSITORY__RESOURCES,
				 DataModelFactory.eINSTANCE.createResource()));
	}
