...
/**
 * This is the item provider adapter for a {@link semanticmanager.SearchResult} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SearchResultItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SearchResult_values_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SearchResult_values_feature", "_UI_SearchResult_type"),
	...
	protected void addResourcesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SearchResult_resources_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SearchResult_resources_feature", "_UI_SearchResult_type"),
				 SemanticmanagerPackage.Literals.SEARCH_RESULT__RESOURCES,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SemanticmanagerPackage.Literals.SEARCH_RESULT__RESULTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SemanticmanagerPackage.Literals.SEARCH_RESULT__RESULTS,
