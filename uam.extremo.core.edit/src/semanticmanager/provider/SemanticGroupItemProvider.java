		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SemanticGroup_nodes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SemanticGroup_nodes_feature", "_UI_SemanticGroup_type"),
				 SemanticmanagerPackage.Literals.SEMANTIC_GROUP__NODES,
				 true,
				 false,
				 true,
				 null,
