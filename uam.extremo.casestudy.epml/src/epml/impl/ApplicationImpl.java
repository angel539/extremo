 ...
 * </p>
 * <ul>
 *   <li>{@link epml.impl.ApplicationImpl#getOwnedAgents <em>Owned Agents</em>}</li>
 *   <li>{@link epml.impl.ApplicationImpl#getOwnedPlaces <em>Owned Places</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ApplicationImpl extends NamedElementImpl implements Application {
	...
	protected EClass eStaticClass() {
		return EpmlPackage.Literals.APPLICATION;
	}
	...
	public EList<Agent> getOwnedAgents() {
		if (ownedAgents == null) {
			ownedAgents = new EObjectContainmentWithInverseEList<Agent>(Agent.class, this, EpmlPackage.APPLICATION__OWNED_AGENTS, EpmlPackage.AGENT__OWNER);
		}
		return ownedAgents;
	}
	...
	public EList<Place> getOwnedPlaces() {
		if (ownedPlaces == null) {
			ownedPlaces = new EObjectContainmentWithInverseEList<Place>(Place.class, this, EpmlPackage.APPLICATION__OWNED_PLACES, EpmlPackage.PLACE__OWNER);
		}
		return ownedPlaces;
	}
