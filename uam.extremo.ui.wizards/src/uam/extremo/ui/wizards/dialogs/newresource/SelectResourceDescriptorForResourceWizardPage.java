...
public class SelectResourceDescriptorForResourceWizardPage extends WizardPage {
	...
	private List<Resource> descriptors = null;
	
	public SelectResourceDescriptorForResourceWizardPage(String pageName, String pageDescription, List<Resource> descriptors) {
		super(pageName);
		setTitle(pageName);
