...
public class ComposeAQueryWizardDialog extends Wizard{
	public static final String SEARCH_EXTENSIONS_ID = "extremo.core.extensions.search";	
	
	ComposeAQueryWizardPage searchPage = null;
	...
	public ComposeAQueryWizardDialog(Repository repositoryFrom, NamedElement namedElement){
		super();
		...
		searchPage = new ComposeAQueryWizardPage("Search", "Select a search configuration from the query catalogue", searchConfigurations, services, repositoryFrom, namedElement);
	}
	...
	public boolean performFinish() {
		CompositeSearchConfiguration compositeSearchConfigurationSelected = searchPage.getCompositeSearchConfiguration();
