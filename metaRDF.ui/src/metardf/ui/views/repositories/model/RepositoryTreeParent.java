...
public class RepositoryTreeParent extends TreeParent{
	IRepository repository;
	
	public RepositoryTreeParent(IRepository repository) {
	...
	public void drawResources(){		
		for(IResource resource : repository.getResources()){
			ResourceTreeObject object = new ResourceTreeObject(resource);
