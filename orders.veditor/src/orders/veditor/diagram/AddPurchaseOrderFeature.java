...
public class AddPurchaseOrderFeature extends AbstractAddFeature {
	public AddPurchaseOrderFeature(IFeatureProvider fp) { 
		super(fp); 
	}
	...
	public boolean canAdd(IAddContext context) {
		...
		return context.getNewObject() instanceof PurchaseOrder &&
	...
	public PictogramElement add(IAddContext context) {
		...
		PurchaseOrder newPurchaseOrder = (PurchaseOrder)context.getNewObject();
