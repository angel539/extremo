package uam.extremo.ui.extensions.dnd;
...
public class DraggableNamedElementTransfer extends ByteArrayTransfer{
	...
	public void javaToNative(Object object, TransferData transferData) {
		List<NamedElement> draggableNamedElements = new ArrayList<NamedElement>();

		if(object instanceof SemanticNode){
			SemanticNode semanticNode = (SemanticNode) object;
			SemanticNode draggableSemanticNode = SemanticmanagerFactory.eINSTANCE.createSemanticNode();
			draggableSemanticNode.setName(semanticNode.getName());
			draggableNamedElements.add(draggableSemanticNode);
		}
		
		NamedElement[] namedElementsArray = new NamedElement[draggableNamedElements.size()];
