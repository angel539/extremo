...
public class FlattenedMMComparatorUnmatchesMatrix extends MMComparator{
	...
	public FlattenedMMComparatorUnmatchesMatrix() throws IOException {
		super();
	}
	...
	protected void generateStatsMatches() throws IOException{
        ...
        FileOutputStream fileOut = new FileOutputStream("logs/exact-flattened/stats/exact-flattened-unmatches-matrix.xlsx");
	...
	protected void generateFilesMatches() throws IOException {
		...
		for(Entry<Tuple<File, File>, List<ENamedElement>> entry : this.unmatchesLeft.entrySet()){
			...
			String fileNameX = FilenameUtils.removeExtension(tuple.x.getName());
			String fileNameY = FilenameUtils.removeExtension(tuple.y.getName());
			Path file = Paths.get("logs/exact-flattened/unmatches-matrix/" + fileNameX + "-" + fileNameY + "-left" + ".txt");
		...
		for(Entry<Tuple<File, File>, List<ENamedElement>> entry : this.unmatchesRight.entrySet()){
			...
			String fileNameX = FilenameUtils.removeExtension(tuple.x.getName());
			String fileNameY = FilenameUtils.removeExtension(tuple.y.getName());
			Path file = Paths.get("logs/exact-flattened/unmatches-matrix/" + fileNameX + "-" + fileNameY + "-right" + ".txt");
